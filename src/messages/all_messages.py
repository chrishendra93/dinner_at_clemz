...
class Eko(Tomodachi):
    ...
    def __init__(self):
        ...
        message = '''Dittt!! All the best and good luck di colum yah!! We’re gonna miss u here but see u man in 2023!'''
...
class Ida(Tomodachi):
    ...
    def __init__(self):
        ...
        message = '''Dude, it’s the end of an era! Truly happy (and a lil bit jealous) for you and your exciting new chapter ahead! Deeply treasure the friendship we have, with the emo-rgencies
          conversations every now and then. It is always easy to have real talks with you. 
          I’m gonna miss you loads, dude! I believe in friendships that will not decay no matter how long and how far apart. That’s us! Congratulations!!! I’ll see you when I see you 😬'''
...
class Rika(Tomodachi):
    ...
    def __init__(self):
        ...
        message = '''Have fun ya dittt for ur next chapter in life ✨🤩 Excited for what the future has in store for you in the US!'''
...
class Zefa(Tomodachi):
    ...
    def __init__(self):
        name = "Zefa"
        designation = ""
        message = '''Adit!!! Lo ud mau cabut aja ☹️ gw inget pertama kali kita ktmu pas sec school orientation yg yall anak2 ACSI bikin sndiri sm anak2 MGS, smntara gw the odd one out dari sekolah lain yg asal ikutan. 
          Idk about others tapi menurut gw lo itu quite wholesome...
          at least vs batchmates lain yg mayan shady 🤣 all the best in your further studies! Be careful dan carry pepper spray or smth - it's real wild out there.'''
...
class Billy(Tomodachi):
    ...
    def __init__(self):
        name = "Billy"
        designation = ""
        message = '''Semangat ya dit menempuh hidup baru di US. 😬 Just know that even though it might be tough (or might be very chill and fun), you can always find me via whatsapp to talk about anything.
